...
const NavSm = () => {
  ...
  return (
    ...
    <div className= "text-gray-700 flex items-center justify-between">
      <div><h3 className= "text-xl font-bold">{movie.original_title}
           </h3>
      </div>
  ...
  return (
    ...
    <div className= "container flex mx-auto px-4 items-center justify-between">
      ...
      <div className= "flex items-center gap-3">
        <span className= "text-gray-200 text-base flex items-center cursor-pointer hover:text-white">Bangalore, KA<BiChevronDown />
        </span>
...
const MovieNavbar = () => {
  ...
  <nav className ="bg-white border-b-2 lg:border-b-0 lg:bg-darkBackground-700 p-4">
    <div className= "lg:hidden">
      {/* Mobile and Medium sized Screen */}
      <NavSm />
    </div>
